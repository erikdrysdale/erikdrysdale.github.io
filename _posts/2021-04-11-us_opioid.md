...
<table>
    <tr>
        <td> <p align="center">(i) Observed distribution </p> <img src="/figures/gg_pct_lag.png" style="width: 70%;"/> </td>
    </tr>
    <tr>
    ...
    <tr>
        <td> <p align="center">(iii) Violation of parallel trends assumption for Naloxone laws </p> <img src="/figures/gg_naloxone_pt.png" style="width: 65%;"/> 
        </td> 
    </tr>
</table>
...
Rather strangely, the REMA standard errors tend to be smaller when the coefficient is larger than zero, which tends to cause the z-score to have a right-ward bias, especially in the case of Naloxone laws (Figure 5Aii). Because the z-scores under the null are biased and/or have too high of a variance, the null of no effect would be rejected 37% and 24% of the time in favour of a deleterious relationship between Naloxone and Good Samaritan laws and overdose deaths.

<center><h3>Figure 5A: Z-score and standard error estimates from randomization of policy date (REMA) </h3></center>
<table>
    <tr>
