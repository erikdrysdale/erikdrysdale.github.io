...
![ggplot element text size 60](/figures/optimalshrink-1.png)
...
{% endhighlight %}
![ggplot element text size 60](/figures/gcv-1.png)
...
![ggplot element text size 60](/figures/contour_plot-1.png)
