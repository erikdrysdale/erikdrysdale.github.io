...
```{r eth_date,echo=F,fig.height=4,fig.width=7}
gg.seqYear
```
...
```{r gw_scat,echo=F,fig.height=5,fig.width=8}
...
```{r mds,echo=F,warning=F,fig.height=7,fig.width=13}
...
```{r combat,echo=F,warning=F,fig.height=7,fig.width=13}
